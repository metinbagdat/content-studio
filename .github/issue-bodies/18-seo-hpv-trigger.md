...
- [x] Optional GSC overlay (`GSC_SITE_URL` + `GSC_ACCESS_TOKEN`) — short-lived token only
- [ ] Durable GSC OAuth refresh → **CS-WP-03b** (`27-gsc-oauth-refresh.md`); start after posts are indexed
