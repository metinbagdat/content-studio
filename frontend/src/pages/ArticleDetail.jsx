        ...
        <div className="p-8 max-w-6xl">
            ...
            <div className="flex items-start justify-between gap-6 mb-6">
                <div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-[#8A8F98] mt-2">
            ...
            {analysis && (
                <div className="bg-[#191A1B] border border-[#2A2E33] rounded-lg p-6 mb-8" data-testid="analysis-panel">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {(analysis.concepts || []).map((c, i) => <span key={i} className="px-2 py-0.5 rounded bg-[#5E6AD2]/15 text-[#7380E8] text-xs">{c}</span>)}
                            </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {(analysis.quotes || []).slice(0, 3).map((q, i) => (
                                    <div key={i} className="flex gap-2 text-xs text-white/80"><Quote className="w-3 h-3 shrink-0 mt-0.5 text-[#5E6AD2]" /> {q}</div>
                                ))}
                            </div>
                        </div>
                    </div>
